      ...
      <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
            <div
              className="relative rounded-2xl overflow-hidden shadow-card-hover bg-secondary aspect-[16/10]"
              aria-hidden="true"
            >
              {/* Hochwertiger Platzhalter – zu ersetzen durch professionelles Foto */}
              <div className="absolute inset-0 bg-gradient-to-br from-secondary via-blue-100 to-white flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <p className="text-sm text-muted font-medium">Bildplatzhalter</p>
                  <p className="text-xs text-muted/70 mt-1">
                    Professionelles Foto wird hier platziert
                  </p>
                </div>
              </div>
              {/* Dekorative Elemente */}
